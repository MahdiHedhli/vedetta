...
type Device struct {
	...
	// Primary category: "known_exploited" (actively exploited campaign models, e.g. IC3 AVrecon),
	// "eol_eos" (end-of-life/end-of-support), or "high_risk_iot" (weak-default IoT/cameras).
	// RiskReasons vocabulary: "ic3_avrecon", "eol", "possible_eol", "weak_defaults".
