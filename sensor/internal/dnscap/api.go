...
type DNSQuery struct {
	ObservationID string   `json:"observation_id,omitempty"` // opaque occurrence boundary, retained across retries
	...
	Direction     string   `json:"direction,omitempty"` // query or response; enables answerless response pairing
