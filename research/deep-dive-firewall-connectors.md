...
#### Live Client Response Example (from the test network)
...
#### Live Network Health Response (from the test network)
...
```json
{
  ...
  "rx_bytes-r": 160646,
  "gw_mac": "<GATEWAY_MAC>",
  "gw_name": "<GATEWAY_MODEL>",
  "gw_system-stats": {
    "cpu": "4.6",
    "mem": "59.7",
    "uptime": "1015169"
  },
  "gw_version": "<FIRMWARE_VERSION>",
...
- **Live testing** — we can validate assumptions against the test <GATEWAY_MODEL>
